...
module position_mudroom() {
    position_garage() {
        translate( [ garage_x() - mudroom_x(), garage_y() + exterior_wall_thickness]) {
            children();
        }
    }
}
...
function greatroom_x() = 25 * ft;
function greatroom_y() = 35 * ft;
...
*/
    position_garage() {
        translate( [ garage_x() + exterior_wall_thickness, greatroom_offset()]) {
            children();
        }
    }
}
...
function southeast_wing_y() = powder_room_y() + southeast_hallway_width() + 2 * interior_wall_thickness + master_closet_y();
module position_southeast_wing() {
    position_greatroom() {
        translate( [ greatroom_x() + exterior_wall_thickness, -southeast_wing_offset()]) {
            children();
        }
    }
}
