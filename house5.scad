...
function greatroom_roof_x() = greatroom_x() + 2 * exterior_wall_thickness + 2 * greatroom_roof_overhang();
...
function southeast_wing_roof_x() = southeast_wing_roof_overhang() * 2 + exterior_wall_thickness * 2 + southeast_wing_x();
...
module position_southeast_wing_roof() {
    position_southeast_wing() {
        translate( [ southeast_wing_roof_x() - southeast_wing_roof_overhang() - exterior_wall_thickness, -southeast_wing_roof_overhang() - exterior_wall_thickness, 0]) {
            mirror( [ 1, 0, 0]) {
                children();
            }
        }
...
module southeast_wing_roof_cutout() {
    position_southeast_wing_roof() {
        shed_roof_cutout( southeast_wing_roof_spec());
    }
}
