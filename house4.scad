...
northwest_section_roof_spec = shed_roof_spec_from_slope(
        sloped_span = northwest_section_roof_x,
        flat_span = northwest_section_roof_y,
        slope = 3.0 / 12,
...
position_building_area() {
    rotate( [ 0, 0, southeast_boundary_angle - northwest_boundary_angle]) {
        translate( [ 0, 1 * ft, 0]) {
            house();
        }
    }
